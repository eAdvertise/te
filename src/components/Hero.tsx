      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          <span className="inline-block px-4 py-2 bg-primary/20 text-primary-foreground rounded-full text-sm font-medium mb-6 backdrop-blur-sm border border-primary/30">
            Quality Mediterranean Construction
          </span>
          
          
          
          <p className="text-lg text-primary-foreground/90 mb-8 leading-relaxed md:text-sm">A quality property construction and development company specializing in renovation of or brand new homes. Our team of co-operative architects, engineers, and craftsmen bring together traditional Mediterranean aesthetics with modern innovation.</p>
