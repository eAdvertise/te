            ...
            return <div key={index} className="rounded-xl overflow-hidden bg-card shadow-sm p-6 flex flex-col justify-center">
                  ...
                  <div className="text-muted-foreground text-sm leading-relaxed space-y-3">
                    <div>
                      ...
                      <p>Starting from €185,000 for 2-bedroom units</p>
                      <p>3-bedroom units from €225,000</p>
                    </div>
                    <div>
                      <p className="font-medium text-foreground mb-1">Availability</p>
                      <p>Limited units remaining • Pre-sales now open</p>
                      <p>Expected completion: Q4 2025</p>
                    </div>
                    <div>
                      <p className="font-medium text-foreground mb-1">Location Highlights</p>
                      <p>200m from supermarket • 1.7km from the sea</p>
                      <p>Walking distance to restaurants & cafes</p>
                    </div>
                  </div>
                </div>;
          }
